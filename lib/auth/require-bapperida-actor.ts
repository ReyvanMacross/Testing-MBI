...
export async function requireBapperidaActor(): Promise<BapperidaActor> {
  ...
  if (
    ...
    profile.role !== "INTERVENSI" || !profile.opd_id || opd?.kode_opd !== "BAPPERIDA"
