...
export async function requireDisbudparActor(): Promise<DisbudparActor> {
  ...
  if (
    ...
    profile.role !== "INTERVENSI" || !profile.opd_id || opd?.kode_opd !== "DISBUDPAR"
  ) {
