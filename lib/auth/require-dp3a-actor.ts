...
export async function requireDp3aActor(): Promise<Dp3aActor> {
  ...
  if (
    profileError || !profile || profile.status !== "AKTIF" || profile.role !== "INTERVENSI" ||
    !profile.opd_id || opd?.kode_opd !== "DP3A"
