...
export async function requireCiptaBintarActor(): Promise<CiptaBintarActor> {
  ...
  if (
    ...
    profile.role !== "INTERVENSI" || !profile.opd_id || opd?.kode_opd !== "CIPTA_BINTAR"
  ) {
