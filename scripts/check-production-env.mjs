...
for (const name of ["DISNAKER_PREVIEW_MODE", "DISKOP_PREVIEW_MODE", "DISDIK_PREVIEW_MODE", "DP3A_PREVIEW_MODE", "DISDAGIN_PREVIEW_MODE", "DKPP_PREVIEW_MODE", "DISBUDPAR_PREVIEW_MODE", "CIPTA_BINTAR_PREVIEW_MODE", "BAPPERIDA_PREVIEW_MODE"]) {
