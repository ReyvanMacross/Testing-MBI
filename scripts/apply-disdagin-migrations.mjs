...
const migrations = [
  "202609130001_disdagin_workflow_foundation.sql",
  "202609130002_disdagin_operational_rpcs.sql",
  "202609130003_disdagin_final_hardening.sql",
  "202609130004_disdagin_completion_report_integrity.sql",
];
...
await withStagingDatabase(async (database) => {
  ...
  if (Object.values(baseline.rows[0]).some((value) => value !== true)) {
    throw new Error("Baseline integrasi staging belum lengkap; migration Disdagin tidak diterapkan.");
  }
