...
const migrations = [
  "202609150001_disbudpar_workflow_foundation.sql",
  "202609150002_disbudpar_operational_rpcs.sql",
  "202609150003_disbudpar_final_hardening.sql",
...
await withStagingDatabase(async (database) => {
  ...
  if (Object.values(baseline.rows[0]).some((value) => value !== true)) {
    throw new Error("Baseline integrasi staging belum lengkap; migration Disbudpar tidak diterapkan.");
  }
